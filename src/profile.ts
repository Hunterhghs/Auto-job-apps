...
export function knownAnswers(p: Profile): Record<string, string> {
  return {
    ...
    "email address": p.contact.email,
    "e-mail": p.contact.email,
    phone: p.contact.phone,
    "phone number": p.contact.phone,
    telephone: p.contact.phone,
    "mobile number": p.contact.phone,
    ...
    "linkedin url": p.links.linkedin || p.links.upwork,
    website: p.links.website,
    portfolio: p.links.website,
    "personal website": p.links.website,
    "current company": "H Heuristics",
    "current employer": "H Heuristics",
    "most recent company": "H Heuristics",
    ...
    "available to start": p.preferences.noticePeriod,
